...
global C
global Vx Vy Vz x y z Fx Fy Fz AtomSpacing
...
% if nAtoms2
%     V2_1 = (Vx(Pty2in).*Vx(Pty2in) + Vy(Pty2in).*Vy(Pty2in) + Vz(Pty2in).*Vz(Pty2in));
% else
%     V2_1 = 0;
% end
...
while t < TStop
    ...
    if Method == 'FD'
        ...
        dy(Pty2in) = Vx(Pty2in) * dt + Fy(Pty2in) * dt^2 / 2 / Mass2;
