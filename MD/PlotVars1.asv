...
function [ output_args ] = PlotVars1(c, Limits)
...
hold on
subplot(3, 2, 1),quiver(x, y, z, Fx * ScaleF, Fy * ScaleF,  0, 'm', 'linewidth', 2);
hold off
axis(Limits);
...
subplot(3,2,3), plot(x(Pty2in), y(Pty2in), 'ro', 'markers',...
    MarkerSize,'MarkerFaceColor','r');
subplot(3,2,3),quiver(x, y, z, Vx * ScaleV, Vy * ScaleV, 0, 'r', 'linewidth', 2);
hold off
axis(Limits);
